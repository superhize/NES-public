    ...
    companion object {
        ...
        private fun drawHoveringText(posX: Int, posY: Int, tips: List<String?>, stack: ItemStack? = null) {
            if (tips.isNotEmpty()) {
                ...
                val color: Char = stack?.getItemRarity() ?: Utils.getPrimaryColourCode(textLines[0])
