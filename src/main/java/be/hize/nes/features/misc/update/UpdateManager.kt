...
object UpdateManager {
    ...
    fun onConfigLoad(event: ConfigLoadEvent) {
        NES.feature.about.updateStream.onToggle {
            reset()
        }
    }
    ...
    val config get() = NES.feature.about
            ...
            .thenAcceptAsync({
                ...
                if (it.isUpdateAvailable) {
                    ...
                    LorenzUtils.clickableChat(
                        "§e[NES] §aNES found a new update: ${it.update.versionName}. " +
                            "Go check §b/nes download update §afor more info.",
                        "nes"
                    )
                }
    ...
    val context = UpdateContext(
        UpdateSource.githubUpdateSource("superhize", "NES-public"),
        UpdateTarget.deleteAndSaveInTheSameFolder(UpdateManager::class.java),
        CurrentVersion.ofTag(NES.version),
        NES.MODID,
    )
